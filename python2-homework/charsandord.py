...
# listába szedjük a szavakat, írásjeleket eltávolítjuk
szo_list2 = []
for i in range(len(szo_list)):
    szo = szo_list[i].strip('.,;:-?"')
    szo_list2.append(szo.lower())

# megszámoljuk a szavakat
d = {}
for j in szo_list2:
    d[j] = szo_list2.count(j)

# kiíratjuk a számolás eredményét
for k, v in d.items():
    print(k, v)
